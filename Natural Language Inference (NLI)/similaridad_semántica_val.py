# -*- coding: utf-8 -*-
"""Similaridad semántica_Val.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1HVKxwP4M2K0g9UucKfGpHevUiIJRwZuR
...
tokenizer.tokenize(dataset['dev'][0]['sentence1'])

tokenizer(dataset['dev'][0]['sentence1'])
...
inputs_s1, inputs_s2, similarity_score = next(iter(val_dataloader))
...
labels = dataset['dev']['similarity_score']
