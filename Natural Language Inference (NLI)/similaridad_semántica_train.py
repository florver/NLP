# -*- coding: utf-8 -*-
"""Similaridad semántica_Train.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vZ39kvxi-H0C7Lmzj1LeV78ZVajpixMz
...
tokenizer.tokenize(dataset['train'][0]['sentence1'])

tokenizer(dataset['train'][0]['sentence1'])
...
inputs_s1, inputs_s2, similarity_score = next(iter(train_dataloader))
...
labels = dataset['train']['similarity_score']
